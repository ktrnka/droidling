...
public class InterpersonalCard extends RecyclableCard {
    ...
    public InterpersonalCard(String title, InterpersonalSingleStats stats, Context activityContext,
        ...
        shareListener = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                String subject = "Shared stats from "
                        + InterpersonalCard.this.activityContext.getString(R.string.app_name);
                String text = "Stats: "
                        + InterpersonalCard.this.title
                        + ":\n"
                        + InterpersonalCard.this.stats
                                .toString(InterpersonalCard.this.activityContext);
                ...
                InterpersonalCard.this.activityContext.startActivity(Intent.createChooser(
                        sendIntent,
                        InterpersonalCard.this.activityContext.getString(R.string.share_intent)));
            }
        };
    }
    ...
    protected void applyTo(View convertView) {
        ...
        ((TextView) convertView.findViewById(R.id.mainText)).setText(stats.getFormatted(convertView
                .getContext()));
        ...
        if (stats.photoUri != null) {
            ...
            try {
                setImage(contactImageView, convertView.getContext(),
                        BitmapLoaderTask.packIntoUri(R.drawable.ic_contact_picture), imageSize,
                        imageSize);
            } catch (IOException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
