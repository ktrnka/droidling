...
public class InterpersonalSingleStats {
    ...
    private void appendFormatted(Context context, SpannableStringBuilder reusableBuilder,
            SpannableStringBuilder destinationBuilder, int stringId) {
        reusableBuilder.clear();
        reusableBuilder.clearSpans();
        reusableBuilder.append(context.getString(stringId));
        reusableBuilder.setSpan(new StyleSpan(Typeface.BOLD), 0, reusableBuilder.length(),
