...
public class LanguageIdentificationActivity extends RefreshableActivity {
    ...
    public static final String[] PROFILING_KEY_ORDER = {
            LOAD_CONTACTS_KEY, LOAD_MESSAGES_KEY, IDENTIFYING_KEY, GENERATE_TEXT_KEY,
            SAVE_DISPLAY_KEY
    };
    ...
    private void buildRuntimeDisplay() {
        final String runtimeString = MainActivity.summarizeRuntime(getApplicationContext(),
                PROFILING_KEY_ORDER);
     ...
     */
    public View inflateResults(LayoutInflater inflater, final CharSequence name,
