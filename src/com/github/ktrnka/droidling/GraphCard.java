...
public class GraphCard extends RecyclableCard {
    ...
    public GraphCard(String title, GraphicalView graphView, String applicationName,
    ...
    protected void applyTo(View convertView) {
        ...
        // Maybe I should set a target aspect ratio for the graph and trigger
        // from the width.
        WindowManager wm = (WindowManager) convertView.getContext().getSystemService(
        ...
        container.addView(graphView, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT,
                screenHeight / 3));
    ...
    private class ShareListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.FROYO) {
                ...
                File externalDir = new File(externalRoot.getAbsolutePath() + "/Android/data/"
                        + packageName + "/files");
